...
class OrdersDeserializerTest {
    ...
    void testSerializer() {
        ...
        mo.setOrders(orders);
        String json = JsonUtils.objectToString(mo);
        assertNotNull(json);
    }
    ...
    void testDeserializerSingleNull() {
        String json = "null";
        Orders orders = JsonUtils.stringToObject(json, Orders.class);
        assertNull(orders);
    }
    ...
    void testDeserializerSingleString() {
        ...
        log.info(JsonUtils.objectToString(orders));
    }
    ...
    void testDeserializerOrdersNull() {
        ...
        ModelOrders mo = JsonUtils.stringToObject(json, ModelOrders.class);
    ...
    void testDeserializerOrdersString() {
        ...
        log.info(JsonUtils.objectToString(mo));
    }
