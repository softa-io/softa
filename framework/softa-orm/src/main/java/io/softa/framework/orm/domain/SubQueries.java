...
public class SubQueries implements Serializable {
    ...
    /**
     * Expand the subQuery conditions based on relational fields.
     *
     * @param method Field lambda method reference
     * @param subQuery SubQuery condition
     */
    public <T, R> SubQueries expand(SFunction<T, R> method, SubQuery subQuery) {
        String field = LambdaUtils.getAttributeName(method);
        this.queryMap.put(field, subQuery);
        return this;
    }
