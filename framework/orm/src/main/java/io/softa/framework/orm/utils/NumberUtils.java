...
public class NumberUtils {
    ...
    public static long numberToLong(Object number) {
        ...
        if (number instanceof Number numValue) {
    ...
    private static Object sumNumber(Object v1, Object v2, ValueType valueType) {
        ...
        switch (valueType) {
            case INTEGER:
                v2 = v2 instanceof BigDecimal bigV2 ? bigV2.intValue() : v2;
                value = Integer.sum((Integer) v1, (Integer) v2); break;
            case LONG:
                v2 = v2 instanceof BigDecimal bigV2 ? bigV2.longValue() : v2;
                value = Long.sum((Long) v1, (Long) v2); break;
            case DOUBLE:
                v2 = v2 instanceof BigDecimal bigV2 ? bigV2.doubleValue() : v2;
