...
import io.softa.starter.designer.dto.DesignAppVersionDTO;
...
public class DesignAppVersionController extends EntityController<DesignAppVersionService, DesignAppVersion, Long> {
    ...
    public ApiResponse<Long> createOne(@RequestBody DesignAppVersionDTO appVersionDTO) {
        ...
        Assert.notNull(appVersionDTO.getEnvId(), "Env ID is required.");
        DesignAppVersion appVersion = BeanTool.objectToObject(appVersionDTO, DesignAppVersion.class);
