...
public class RemoteApiClientImpl implements RemoteApiClient {
    ...
    public List<Map<String, Object>> fetchRuntimeMetadata(DesignAppEnv appEnv, String runtimeModelName) {
        String url = URLUtils.buildUrl(appEnv.getUpgradeEndpoint(), MetadataConstant.METADATA_EXPORT_API);
        String accessToken = appEnv.getClientSecret();
        // POST with modelName as query param
        Object data = this.callRemoteApi(accessToken, url + "?modelName=" + runtimeModelName, null);
